...
This document is taken and adapted from [knx-go](https://github.com/vapourismo/knx-go).

## KNXnet/IP Group Client

If you simply want to send and receive group communication, the
[GroupTunnel](https://godoc.org/github.com/mobilarte/knx-exp/knx#GroupTunnel) or
[GroupRouter](https://godoc.org/github.com/mobilarte/knx-exp/knx#GroupRouter)
...
import (
	...
	"github.com/mobilarte/knx-exp/knx"
...
Use [Tunnel](https://godoc.org/github.com/mobilarte/knx-exp/knx#Tunnel) or
[Router](https://godoc.org/github.com/mobilarte/knx-exp/knx#Router) for finer control over the
communication with a gateway or router.

## KNX Bridge

Caveat: not yet include in `knx-exp`.
...
func main() {
	// Setup logger for auxiliary logging. This enables us to 
    // see log messages from internal routines.
	util.Logger = log.New(os.Stdout, "", log.LstdFlags)
